...
export async function PUT(req: NextRequest, ctx: RouteContext<'/api/proxy/admin/users/[id]/sessions/[sessionId]'>) {
    const { id, sessionId } = await ctx.params;
    return forward(req, `/admin/users/${id}/sessions/${sessionId}`, true);
}
